<?php 
	...
	get_sidebar();
	if ( have_posts() ) : ?>
			<h2 class="searches-title"><?php echo __('Search results for "', 'handcraft-expo'); the_search_query(); ?>":</h2>
<?php				
...
<?php } ?>
			<p class="handcraft-expo-page-default-content"><?php the_excerpt(); ?>
<?php 
