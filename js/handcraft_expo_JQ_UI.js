...
(function(){
	...
	jQuery(".navbar-container li").not(".sub-menu li").each(function(){
	    if ( jQuery(this).hasClass("menu-item-has-children") ){
		var heMenuItems = jQuery(this).children("ul");
		jQuery(this).append('<span class="handcraft-expo-main-menu-sub-menu-icon"></span>');
		jQuery(this).mouseenter(function(){
		    heMenuItems.slideDown(300);
		});
		jQuery(this).mouseleave(function(){
		    heMenuItems.slideUp(300);
		});
	    }
	});
    });
    ...
    jQuery(document).ready(function(){
	jQuery(".navbar-container li .sub-menu li").each(function(){
	    if ( jQuery(this).hasClass("menu-item-has-children") ){
		var heSubMenuItems = jQuery(this).children("ul");
		jQuery(this).append('<span class="handcraft-expo-main-menu-sub-menu-icon"></span>');
		jQuery(this).mouseenter(function(){
		    heSubMenuItems.slideDown(300);
		});
		jQuery(this).mouseleave(function(){
		    var heMenuParentList = jQuery(this).parent("ul");
		    if ( heMenuParentList.hasClass("menu-item-has-children")){
			heSubMenuItems.slideUp(300);
		    }
		});
	    }
	});
